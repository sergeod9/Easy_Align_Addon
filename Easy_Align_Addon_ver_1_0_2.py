...
class Easy_A_panel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row.operator("object.origin_set","Snap")
        ...
        row.operator("object.to_world_center","To World Center")
        row.operator("object.to_floor","To Floor")
...
def register():
    ...
    bpy.utils.register_class(To_world_center)
    bpy.utils.register_class(To_floor)
...
def unregister():
    ...
    bpy.utils.unregister_class(To_world_center)
    bpy.utils.unregister_class(To_floor)
